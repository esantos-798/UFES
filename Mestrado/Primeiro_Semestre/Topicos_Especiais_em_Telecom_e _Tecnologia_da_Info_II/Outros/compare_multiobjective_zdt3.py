...
# Configuração do problema ZDT3 padrão na pymoo (D=30, 2 objetivos)
...
plt.title('Batalha de Meta-heurísticas: MOHAF vs Estado da Arte (ZDT3)', fontsize=12, fontweight='bold')
