...
print("Iniciando o Confronto Final de Modelos (Árvore vs RF vs SVR)...")
...
modelos_nomes = ['Árvore de Decisão', 'Random Forest', 'SVR (Kernel RBF)']
preds = [y_pred_tree, y_pred_rf, y_pred_svr]
...
print("\n=========================================================================")
print("TABELA COMPARATIVA DE DESEMPENHO DEFINITIVA:")
print(df_confronto.round(6).to_string(index=False))
print("=========================================================================")

# 3. Salvar os resultados para o relatório
df_confronto.round(6).to_csv('tabela_confronto_final_ufes.csv', sep=';', index=False)
print("\nTabela final consolidada e salva em 'tabela_confronto_final_ufes.csv'!")