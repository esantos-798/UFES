...
df = load_and_engineer_features("data/SoftFailure_dataset.csv")
...
torch.save({'model_state': model.state_dict(), 'thresholds': thresholds}, "lstm_soft_failure_baseline.pt")
print("Modelo salvo em 'lstm_soft_failure_baseline.pt'")