"""
Camera Visualizer - Assignment 1
...
# ---------------------------------------------------------------------------
# Object definition – a simple coloured house-shaped object
# ---------------------------------------------------------------------------

def build_object_vertices():
    """
    Returns (N,3) array of vertices for a simple 3-D house and
    a list of faces (each face is a list of vertex indices).
    """
    # Base box  (±1 in X, 0-1.5 in Y, ±1 in Z)
    verts = np.array([
        # box bottom
        [-1, -1,  0],   # 0
        [ 1, -1,  0],   # 1
    ...
    face_colors = [
        ...
        "#aaddff","#aaddff",
        "#88bbee","#88bbee",
        "#ff9966","#ff9966","#ff9966","#ff9966",
    ]
    return verts, faces, face_colors


OBJECT_VERTS, OBJECT_FACES, OBJECT_COLORS = build_object_vertices()
...
class CameraApp(tk.Tk):
    def __init__(self):
        ...
        self.cam_ty = tk.DoubleVar(value=-6.0)
        self.cam_tz = tk.DoubleVar(value=2.0)
    ...
    def _draw_3d(self):
        ...
        ax.set_title("3D Scene", color="#cdd6f4", pad=6, fontsize=11)
    ...
    def _reset(self):
        self.cam_tx.set(0.0); self.cam_ty.set(-6.0); self.cam_tz.set(2.0)
